...
export default function Sidebar({ projects, idSelectedProject, onAddProject, onSelectProject }) {
    return (
        <aside className="bg-gray-900 text-white p-4 overflow-y-auto">
            ...
            <ul className="space-y-2">
                {projects.map((project) => (
                    <li
                        ...
                        className={`p-2 rounded cursor-pointer hover:bg-gray-800 ${idSelectedProject === project.id ? "bg-gray-700" : ""
                            }`}
                    >
                        {project.title}
                    </li>
